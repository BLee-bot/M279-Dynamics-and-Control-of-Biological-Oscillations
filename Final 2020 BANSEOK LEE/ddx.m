...
function ddx = ddx(tt,xx,K,P,Bp,Cp,XX,UU,Beta1,O,phih)
    ...
    % get Zeta dot
    ddx(1:10,:) = (blkdiag(A1,A2,A3,A4,A5) + R)*x0; 
    ...
    AAA = P*AA*inv(P);
    ddx(11:20,:) = AAA*x6 +Bp*u;
    
    % get v dot 
    thetadot = inv(B')*[xx(12,:);xx(14,:);xx(16,:);xx(18,:);xx(20,:)];
    theta = inv(B')*[xx(11,:);xx(13,:);xx(15,:);xx(17,:);xx(19,:)];
    dtheta = ct0 +e'*Ct*e+theta'*C0*theta;
    ddx(21,:) = (-dtheta*v-thetadot'*Lamda*theta)/m;
