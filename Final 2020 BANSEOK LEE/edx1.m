...
function edx1 = edx1(ttt,xxx,K,P,Bp,Cp,XX,UU,Beta1,O,phih,LL,eps)
    ...
    % get Zeta dot
    edx1(1:10,:) = (blkdiag(A1,A2,A3,A4,A5) + R)*x0; 
    ...
    AAA = P*AA*inv(P);
    edx1(11:20,:) = AAA*x6 +Bp*u;
    
    % get v dot 
    thetadot = inv(B')*[xxx(12,:);xxx(14,:);xxx(16,:);xxx(18,:);xxx(20,:)];
    theta = inv(B')*[xxx(11,:);xxx(13,:);xxx(15,:);xxx(17,:);xxx(19,:)];
    dtheta = ct0 +e'*Ct*e+theta'*C0*theta;
    edx1(21,:) = (-dtheta*v-thetadot'*Lamda*theta)/m;
